      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-[3fr_2fr]">
        ...
        <form action={prospectOpslaan} className="kaart flex min-w-0 flex-col gap-3 p-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <label className="flex flex-col gap-1"><span className="label">Kans %</span><input name="kans" inputMode="numeric" defaultValue={String(x.kans)} className="veld cijfers" /></label>
